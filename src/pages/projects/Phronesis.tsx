...
const highlights = [
  { value: "Métricas", label: "Lectura clara de datos" },
  { value: "Reportes", label: "Jerarquía de información" },
  { value: "Responsive", label: "Desktop · Tablet · Mobile" },
];

const decisions = [
  "Definir jerarquías claras para métricas y módulos principales.",
  "Organizar reportes y dashboards para lectura rápida y claridad operativa.",
  "Convertir datos complejos en información más fácil de revisar.",
  "Mantener consistencia entre navegación, tablas, métricas y estados.",
];
          ...
          <div className="reveal reveal-delay-1 grid grid-cols-1 gap-9 lg:grid-cols-12 lg:items-end lg:gap-12">
            <div className="space-y-6 lg:col-span-8">
              <span className="inline-flex items-center gap-3 text-xs uppercase tracking-[0.22em] text-muted-foreground">
                ...
                Otros proyectos digitales · Métricas · Reportes
              </span>
            ...
            <p className="max-w-xl text-base leading-relaxed text-muted-foreground text-pretty lg:col-span-4 lg:text-lg">
              Proyecto digital secundario enfocado en métricas, reportes y organización clara de información.
            </p>
          </div>
      ...
      <section className="py-12 sm:py-24 lg:py-36">
        <div className="container grid grid-cols-1 gap-8 sm:gap-12 lg:grid-cols-12 lg:gap-20">
          <aside className="lg:col-span-4">
            <div className="scroll-reveal sticky top-28 space-y-4 sm:space-y-6 lg:top-32 lg:space-y-7">
              ...
              <p className="max-w-xs text-sm leading-relaxed text-muted-foreground">
                Estructura visual diseñada para simplificar información compleja mediante dashboards claros y reportes legibles.
              </p>
          ...
          <div className="space-y-10 sm:space-y-14 lg:col-span-7 lg:col-start-6 lg:space-y-20">
            ...
            <CaseBlock title="Hipótesis" body="Un dashboard con jerarquía clara y organización consistente puede mejorar comprensión, navegación y lectura de métricas." />
            ...
            <section className="scroll-reveal overflow-hidden rounded-[1.75rem] border border-hairline bg-surface/20 p-3 shadow-soft transition-all duration-700 hover:-translate-y-1 hover:border-accent/25 hover:bg-surface/32 sm:p-5 lg:p-7">
              <div className="mb-6 flex items-center justify-between gap-6 border-b border-hairline pb-5">
                <p className="text-[11px] uppercase tracking-[0.24em] text-muted-foreground/88">Supporting content</p>
                <span className="text-xs text-muted-foreground/58">Detalle de métricas</span>
              </div>
              <img
                src={phronesisSystem}
            ...
            <CaseBlock title="Solución" body="Organización de dashboards y reportes con foco en claridad, navegación intuitiva y lectura eficiente de información compleja." />
            <CaseBlock title="Resultado" body="Experiencia estructurada para facilitar lectura rápida, exploración de datos y revisión de métricas sin perder consistencia." />
            <CaseBlock title="Aprendizajes" body="En productos basados en información, la jerarquía y la claridad operativa son más importantes que la densidad visual. Menos ruido genera mejores decisiones." />
